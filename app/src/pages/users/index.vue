...
import { UserSchema } from 'adfinity-ui-schemas';
...
const { page, limit, search, sort, data, error, refetch, isPending, limitItems, pagination } =
  useQueryPagination(
    ['users'],
    ({ page, limit, search, sort }) => client.user.list.query({ page, limit, search, sort }),
